...
public class Stream_01_Test {
	...
	public void test_stream_filter() throws Exception {
		...
		System.out.println("Pizzas avec prix >= 1300 : " + result);
	...
	public void test_stream_filter_collect_counting() throws Exception {
		...
		System.out.println("Nombre de pizzas avec prix >= 1300 : " + result);
		System.out.println("");
	...
	public void test_stream_anyMatch() throws Exception {
		...
		System.out.println("Au moins une pizza avec prix >= 1300 : " + result1);
		System.out.println("Au moins une pizza avec prix >= 2000 : " + result2);
		System.out.println("");
	...
	public void test_stream_allMatch() throws Exception {
		...
		System.out.println("Toutes les pizzas ont un prix >= 1300 : " + result1);
		System.out.println("Toutes les pizzas ont un prix >= 900 : " + result2);
		System.out.println("");
	...
	public void test_stream_noneMatch() throws Exception {
		...
		System.out.println("Aucune pizza avec prix >= 2000 : " + result1);
		System.out.println("");
		assertThat(result1, is(true));
	}
	...
	public void test_stream_findFirst() throws Exception {
		...
		System.out.println("Commande par un client nommé Sophie : " + result);
		System.out.println("");
	...
	public void test_stream_filter_adv() throws Exception {
		...
		System.out.println("Commandes contenant au moins une pizza Pépéroni : " + result);
		System.out.println("Taille de la liste des commandes : " + result.size());
		System.out.println("");
		assertThat(result, hasSize(3));
	}
}
