...
public class Stream_02_Test {
	...
	public void test_map() throws Exception {
		...
		System.out.println("Liste des clients associés aux commandes : " + result);
	...
	public void test_map_count() throws Exception {
		...
		System.out.println("Nombre total de clients associés aux commandes : " + result);
		System.out.println("");
	...
	public void test_map_distinct() throws Exception {
		...
		System.out.println("Liste des différents clients associés aux commandes : " + result);
	...
	public void test_map_distinct_count() throws Exception {
		...
		System.out.println("Nombre de différents clients associés aux commandes : " + result);
		System.out.println("");
	...
	public void test_mapToDouble_sum() throws Exception {
		...
		System.out.println("Chiffre d'affaires total de la pizzeria : " + result);
		System.out.println("");
	...
	public void test_mapToDouble_avg() throws Exception {
		...
		System.out.println("Prix moyen d'une commande : " + (result.isPresent() ? result.getAsDouble() : "Non disponible"));
		System.out.println("");
